...
# Task: train the language model to get the Jukebox embedding (VQVAE is fixed)
"""
- Resample the waveform to 44.1 khZ
- Normalize it
- Codify using the Jukebox VQ-VAE model
- Input the codified audio into language model
- Get its layer-wise activations as representations
"""
...
if __name__ == "__main__":
    ...
    from jukebox_lib.jukebox.hparams import Hyperparams, setup_hparams
    from jukebox_lib.jukebox.make_models import MODELS, make_prior, make_vqvae
    from jukebox_lib.jukebox.utils.dist_utils import setup_dist_from_mpi
